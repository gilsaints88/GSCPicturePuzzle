...
public class HighScore4x4 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String highTimes = getIntent().getStringExtra(HIGH_TIMES_4x4);
		String highNames = getIntent().getStringExtra(HIGH_NAMES_4x4);
		String highMoves = getIntent().getStringExtra(HIGH_MOVES_4x4);
