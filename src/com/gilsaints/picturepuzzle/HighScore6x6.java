...
public class HighScore6x6 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String highTimes = getIntent().getStringExtra(HIGH_TIMES_6x6);
		String highNames = getIntent().getStringExtra(HIGH_NAMES_6x6);
		String highMoves = getIntent().getStringExtra(HIGH_MOVES_6x6);
